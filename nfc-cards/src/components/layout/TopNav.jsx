        ...
        <header className="">
            {/* <div className="flex items-center gap-2 sm:gap-8 min-w-0">
                <button
                    ...
                    className="lg:hidden w-11 h-11 rounded-xl bg-foreground text-background flex flex-col items-center justify-center gap-1.5 transition-all active:scale-90 shadow-xl border border-black/5 dark:border-white/10 shrink-0"
            ...
            {/* {showActions && !isMenuOpen && (
                <div className="flex items-center gap-2 sm:gap-4">
                    <div className="relative cursor-pointer p-2.5 rounded-xl bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 transition-all border border-black/5 dark:border-white/10 group hidden xs:block">
                        <FiBell size={16} className="text-muted-foreground group-hover:text-foreground transition-colors sm:w-[20px] sm:h-[20px]" />
                        <div className="absolute top-2.5 right-2.5 w-1.5 h-1.5 bg-primary rounded-full border-2 border-white dark:border-zinc-900 shadow-sm"></div>
                    </div>
