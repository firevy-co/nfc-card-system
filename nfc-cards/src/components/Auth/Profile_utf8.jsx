                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-1">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="text-sm font-bold text-black px-1">{formData.country || 'ΓÇö'}</div>
                                )}
                            </div>
                            <div className="space-y-1">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="text-sm font-bold text-black px-1">{formData.state || 'ΓÇö'}</div>
                                )}
                            </div>
                            <div className="space-y-1">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="text-sm font-bold text-black px-1">{formData.city || 'ΓÇö'}</div>
                                )}
                            </div>
                        </div>
                    </div>
