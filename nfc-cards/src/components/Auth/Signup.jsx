            ...
            <div className="flex-1 flex flex-col p-6 sm:p-16 lg:p-24 justify-between max-w-2xl">
                <div>
                    ...
                    <div className="max-w-md">
                        <h1 className="text-4xl font-black text-gray-900 mb-2">Join the Network</h1>
                        <p className="text-gray-500 font-medium mb-10">Create your account to start your NFC journey</p>
                        ...
                        <p className="mt-12 text-sm font-bold text-gray-400">
                            Already have an account? <Link to="/login" className="text-[#7c3aed] hover:text-[#db2777] transition-colors">Sign In</Link>
                        </p>
                    </div>
                </div>
