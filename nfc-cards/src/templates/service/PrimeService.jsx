  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6 font-['Inter']">
      <div className="w-full max-w-sm bg-white border-8 border-slate-900 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden flex flex-col items-center group">
        ...
        <div className="w-16 h-1 bg-slate-900 mb-10 group-hover:w-24 group-hover:bg-blue-600 transition-all" />
        <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase text-center leading-none italic">{displayName || 'Prime Service'}</h1>
        <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.5em] mt-4 mb-12 italic">{role || 'Global Service Lead'}</p>
