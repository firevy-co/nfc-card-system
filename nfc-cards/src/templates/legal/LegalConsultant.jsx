      ...
      <div className="min-h-screen bg-[#0f172a] flex justify-center items-start py-10 px-4 text-white font-['Plus_Jakarta_Sans']">
         <div className="w-full max-w-sm bg-[#1e293b] rounded-[3rem] shadow-2xl overflow-hidden border border-slate-700 p-8 relative">
            ...
            <div className="flex flex-col items-center text-center">
               ...
               <h1 className="text-2xl font-black text-amber-500 tracking-tighter uppercase leading-tight mb-2">
                  {displayName}
               </h1>

               <div className="flex items-center gap-2 text-slate-400 bg-slate-900 px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest mb-10 border border-slate-800">
            ...
            <div className="space-y-4 mb-10">
               <div className="p-5 bg-slate-900/50 rounded-2xl border border-slate-700/50 flex flex-col gap-3 group transition-all hover:bg-slate-900 hover:border-amber-500/30">
                  <div className="flex items-center justify-between">
                     <span className="text-[10px] font-black text-amber-500 uppercase tracking-[0.2em]">Practice Focus</span>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
               <button className="h-16 bg-slate-800 hover:bg-slate-700 rounded-2xl border border-slate-700 transition-all flex flex-col items-center justify-center gap-1 group">
                  ...
                  <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Counsel</span>
               </button>
               <button className="h-16 bg-slate-800 hover:bg-slate-700 rounded-2xl border border-slate-700 transition-all flex flex-col items-center justify-center gap-1 group">
                  <FiMail size={18} className="text-slate-400 group-hover:text-amber-500 transition-colors" />
                  <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Enquiry</span>
               </button>
            </div>

            <button className="w-full bg-amber-500 hover:bg-amber-600 text-slate-950 font-black py-5 rounded-2xl transition-all shadow-xl shadow-amber-500/10 flex items-center justify-center gap-3 uppercase tracking-widest text-xs mb-8">
               <FiUserPlus size={18} />
               Secure Consultation
            </button>
            ...
            <div className="p-6 bg-slate-900 rounded-3xl border border-slate-800 space-y-5">
               <div className="flex items-start gap-4">
                  ...
                  <div>
                     <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest leading-none mb-1">Official Portal</p>
               ...
               <div className="flex items-start gap-4">
                  ...
                  <div>
                     <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest leading-none mb-1">Corporate Office</p>
