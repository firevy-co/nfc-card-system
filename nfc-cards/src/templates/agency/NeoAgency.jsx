    ...
    <div className="w-full h-screen overflow-y-auto overflow-x-hidden scroll-smooth bg-[#0a0f1c] text-white font-['Inter',sans-serif] relative luxury-scrollbar">
      ...
      <div className="w-full max-w-md mx-auto relative z-10 min-h-screen pb-32 border-x border-white/5 bg-[#0a0f1c]/80 backdrop-blur-2xl shadow-[0_0_60px_rgba(0,0,0,0.8)]">
        ...
        <section id="home" className="relative z-20 pb-8">
          <div className="w-full h-72 relative overflow-hidden">
            <img src={data.bannerImage} alt="Cover" className="w-full h-full object-cover opacity-70" />
          ...
          <div className="px-8 relative -mt-28 text-center flex flex-col items-center">
            ...
            <h1 className="text-3xl font-serif font-medium tracking-wide text-white mb-2">{data.displayName}</h1>
            <p className="text-amber-500 text-xs font-bold uppercase tracking-[0.2em] mb-5">{data.role}</p>
        ...
        <motion.section id="about" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={scrollReveal} className="px-8 py-10 border-t border-white/5">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-[#0f1423]/40 border border-white/5 relative">
              ...
              <p className="text-amber-500/90 text-sm leading-loose italic font-serif relative z-10">"{data.mission}"</p>
            </div>
        ...
        {data.services && data.services.length > 0 && (
          <motion.section id="data.services" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={scrollReveal} className="px-8 py-10 border-t border-white/5">
        ...
        {data.portfolio && data.portfolio.length > 0 && (
          <motion.section id="data.portfolio" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={scrollReveal} className="px-8 py-10 border-t border-white/5">
        ...
        <motion.section id="contact" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={scrollReveal} className="px-8 py-10 border-t border-white/5 grid gap-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {data.email && (
              <a href={`mailto:${data.email}`} className="p-5 rounded-2xl bg-[#0f1423]/60 border border-white/10 hover:border-amber-500/50 hover:bg-amber-500/5 transition-all group flex flex-col items-center text-center overflow-hidden">
                ...
                <span className="text-white text-sm font-medium truncate w-full">{data.email}</span>
              </a>
            )}
          </div>
          ...
          {data.address && (
            <div>
              ...
              <a href={`https://maps.google.com/?q=${encodeURIComponent(data.address)}`} target="_blank" rel="noopener noreferrer" className="flex items-center p-6 rounded-2xl bg-[#0f1423]/60 border border-white/10 hover:border-amber-500/30 transition-all group">
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={scrollReveal} className="px-8 py-10 border-t border-white/5">
          ...
          <div className="grid grid-cols-4 gap-4 mb-12">
            {[
              { id: 'data.instagram', val: data.instagram, icon: FiInstagram },
              { id: 'data.linkedin', val: data.linkedin, icon: FiLinkedin },
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] w-[90%] max-w-sm">
        <div className="bg-[#0f1423]/90 backdrop-blur-xl border border-white/10 rounded-[2rem] px-8 py-5 flex justify-between items-center shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <a href="#data.services" className="text-white/40 hover:text-amber-500 transition-colors flex flex-col items-center gap-1 group relative">
          ...
          <a href="#data.portfolio" className="text-white/40 hover:text-amber-500 transition-colors flex flex-col items-center gap-1 group relative">
