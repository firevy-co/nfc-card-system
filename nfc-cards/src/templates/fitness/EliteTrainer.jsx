      ...
      <div className="min-h-screen bg-[#050505] flex justify-center items-start py-8 px-4 text-white font-['Plus_Jakarta_Sans']">
         <div className="w-full max-w-sm bg-gradient-to-br from-[#111] to-[#000] rounded-[3.5rem] shadow-2xl overflow-hidden border border-[#222] p-8 relative">
            ...
            <div className="flex flex-col items-center text-center mt-4">
               ...
               <h1 className="text-4xl font-black text-white tracking-tight uppercase leading-none mb-1 italic">
                  {displayName}
               </h1>

               <div className="flex items-center gap-2 text-lime-500 rounded-full text-[10px] font-black uppercase tracking-[0.4em] mb-10 italic">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
               <div className="p-5 bg-[#111] rounded-3xl border border-[#222] flex flex-col items-center gap-2 group transition-all hover:bg-lime-500">
                  <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500 group-hover:text-black">Availability</span>
                  <span className="text-sm font-black group-hover:text-black">10 spots left</span>
               </div>
               <div className="p-5 bg-[#111] rounded-3xl border border-[#222] flex flex-col items-center gap-2 group transition-all hover:bg-lime-500">
                  <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500 group-hover:text-black">Specialty</span>
            ...
            <div className="flex gap-4 mb-10">
               <button className="flex-1 h-14 bg-white text-black rounded-full shadow-lg flex items-center justify-center gap-3 font-black text-[10px] uppercase tracking-widest hover:bg-lime-500 transition-colors">
                  <FiInstagram size={20} />
                  @Coach_Elite
               </button>
            ...
            {/* ACTION STACK */}
            <button className="w-full h-16 bg-lime-500 hover:bg-lime-600 text-black font-black flex items-center justify-center gap-3 uppercase tracking-widest text-xs rounded-3xl mb-8 transform active:scale-95 transition-all shadow-xl shadow-lime-500/20">
               <FiActivity size={20} />
               Start Protocol
            </button>
            ...
            <div className="space-y-4 mb-4">
               <div className="group flex items-center gap-5 p-4 bg-[#111] rounded-[2rem] border border-[#222] transition-all hover:border-lime-500/40">
                  ...
                  <div className="flex-1">
                     <p className="text-[8px] text-zinc-600 font-black uppercase tracking-widest leading-none mb-1">Elite Portal</p>
               ...
               <div className="group flex items-center gap-5 p-4 bg-[#111] rounded-[2rem] border border-[#222] transition-all hover:border-lime-500/40">
                  ...
                  <div className="flex-1">
                     <p className="text-[8px] text-zinc-600 font-black uppercase tracking-widest leading-none mb-1">Urgent Wire</p>
