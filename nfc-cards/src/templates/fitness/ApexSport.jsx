  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6 font-['Inter']">
      <div className="w-full max-w-sm bg-white border-8 border-slate-900 rounded-[3rem] p-10 shadow-2xl relative overflow-hidden flex flex-col items-center">
        ...
        <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase text-center leading-none">{displayName || 'Apex Sport'}</h1>
        <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.5em] mt-4 mb-12 italic">{role || 'Performance Coach'}</p>
