            ...
            <div className="p-8 bg-zinc-900 text-white">
               <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right">
                     <p className="text-[10px] font-black uppercase tracking-[0.2em] text-orange-500">Project ID</p>
            ...
            <div className="p-8">
               <div className="grid grid-cols-1 gap-4 mb-8">
                  <div className="flex items-center gap-4 p-4 bg-zinc-50 border-l-4 border-zinc-300">
                     ...
                     <span className="text-xs font-bold uppercase tracking-wide">Design Phase Complete</span>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-zinc-50 border-l-4 border-zinc-300">
                     <FiCheckSquare className="text-orange-500" />
                     <span className="text-xs font-bold uppercase tracking-wide">Structural Integrity Verified</span>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-2 gap-px bg-zinc-200 border border-zinc-200 mb-8">
                  <div className="bg-white p-6 flex flex-col gap-2">
                     ...
                     <p className="text-[8px] font-black uppercase text-zinc-400">Portal</p>
                     <p className="text-[10px] font-bold truncate">{website}</p>
                  </div>
                  <div className="bg-white p-6 flex flex-col gap-2">
                     <FiPhone size={18} className="text-orange-500" />
                     <p className="text-[8px] font-black uppercase text-zinc-400">Direct</p>
                  ...
                  <div className="bg-white p-6 flex flex-col gap-2 col-span-2">
                     ...
                     <p className="text-[8px] font-black uppercase text-zinc-400">Site HQ</p>
                     <p className="text-[10px] font-bold truncate">{address}</p>
                  </div>
               </div>

               {/* ENGINEER CTA */}
               <button className="w-full bg-zinc-900 text-white font-black py-5 flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-[10px] hover:bg-orange-500 transition-colors">
                  <FiUserPlus size={16} />
