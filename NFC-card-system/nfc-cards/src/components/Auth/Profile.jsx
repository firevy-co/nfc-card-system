    ...
    return (
        <Layout userData={userData}>
            <header className="mb-12">
                <h2 className="text-4xl font-bold text-foreground mb-3 tracking-tight uppercase">User Identity</h2>
                ...
                <div className="bg-card border border-border rounded-[2.5rem] p-12 shadow-2xl relative overflow-hidden group">
                    <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
                        ...
                        <div className="text-center md:text-left">
                            <h3 className="text-3xl font-bold text-foreground leading-tight uppercase tracking-wide">{user?.displayName || 'Authorized User'}</h3>
                        ...
                        <button className="md:ml-auto px-6 py-3 rounded-xl bg-background border border-border text-foreground font-bold text-[10px] uppercase tracking-widest hover:border-cyan-500/30 transition-all">
                            Edit Identity
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="space-y-2">
                             <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">PRIMARY EMAIL REFERENCE</label>
                             <div className="px-6 py-4 bg-background border border-border rounded-2xl text-foreground font-medium font-sans">
                                {user?.email}
                             </div>
                        </div>
                        <div className="space-y-2">
                             <label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">SYSTEM UID</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-card border border-border p-10 rounded-[1.5rem] shadow-2xl">
                        ...
                        <div className="space-y-6">
                            <button className="w-full flex items-center justify-between px-6 py-5 rounded-2xl bg-background border border-border text-foreground hover:border-cyan-500/30 transition-all group">
                                <span className="text-xs font-bold uppercase tracking-widest">Update Master Key</span>
                            ...
                            <button className="w-full flex items-center justify-between px-6 py-5 rounded-2xl bg-background border border-border text-foreground hover:border-cyan-500/30 transition-all group">
                                <span className="text-xs font-bold uppercase tracking-widest">2-Factor Security</span>
                    ...
                    <div className="bg-card border border-border p-10 rounded-[1.5rem] shadow-2xl flex flex-col justify-between">
                        ...
                        <button 
                            ...
                            className="w-full py-5 rounded-2xl bg-red-500/5 border border-red-500/10 text-red-400 font-bold text-xs uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all mt-8"
                        >
                            Deauthorize Session
                        </button>
                    </div>
