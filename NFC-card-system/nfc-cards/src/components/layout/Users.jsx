            ...
            <header className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-8 p-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-muted-foreground font-medium text-lg max-w-2xl mt-2 opacity-70">
                        Auditing and re-architecting secure identity nodes within the Firevy network orchestration.
                    </p>
                </div>
